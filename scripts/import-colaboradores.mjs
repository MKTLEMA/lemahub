...
const mapped = rows.map((r) => ({
  ...
  contato_emergencia_parentesco:
    r["Contato de emergência (quem)"] || r["Contato de emerg?ncia (quem)"] || "",
  contato_emergencia_nome:
    r["Nome do contato de emergência"] || r["Nome do contato de emerg?ncia"] || "",
  contato_emergencia_telefone:
    r["Telefone do contato de emergência"] || r["Telefone do contato de emerg?ncia"] || "",
